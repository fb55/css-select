...
//so we add them here
filters.not = function(next, token, context){
	var opts = {
...
filters.has = function(next, token){
	...
	if(context){
		return function has(elem){
			...
			context[0] = elem;
			return adapter.existsOne(func, adapter.getChildren(elem));
		};
	}
...
filters.matches = function(next, token, context){
	var opts = {
		xmlMode: !!this.xmlMode,
		strict: !!this.strict,
		rootFunc: next,
