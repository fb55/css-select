...
CSSselect.pseudos.humanoid = function(e, v) {
    return CSSselect.is(e, "li:contains(human)") || CSSselect.is(e, "ol:contains(human)");
};
...
*/
    ...
    "CSS 1": {
        ...
        "deep messy relationships": function() {
            ...
            expect(
                CSSselect(".direct-descend > .direct-descend > .direct-descend ~ .lvl2", document)
...
*/
    ...
    "element-context queries": {
        "relationship-first queries": function() {
            ...
            expect(CSSselect("~ .sibling-selector", CSSselect("#sibling-selector", document))).to.have.length(
                2
            ); //found two siblings with ~ first
            expect(CSSselect("+ .sibling-selector", CSSselect("#sibling-selector", document))).to.have.length(
                1
            ); //found one sibling with + first
