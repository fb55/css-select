...
'pseudo-selectors': {
	...
	':first-child': function () {
		expect(CSSselect('#pseudos div:first-child', document)[0]).to.be(DomUtils.getElementById('pseudos', document).children[0]); //found first child
	...
	':nth-child(odd|even|x)': function () {
		var second = DomUtils.getElementsByTagName('div', DomUtils.getElementById('pseudos', document))[1];
	...
	':first-of-type': function () {
		expect(CSSselect('#pseudos a:first-of-type', document)[0]).to.be(DomUtils.getElementsByTagName('a', DomUtils.getElementById('pseudos', document))[0]); //found first a element
	...
	':only-of-type': function () {
		expect(CSSselect('#pseudos a:only-of-type', document)[0]).to.be(DomUtils.getElementsByTagName('a', DomUtils.getElementById('pseudos', document))[0]); //found the only a element
		expect(CSSselect('#pseudos a:first-of-type', document)).to.have.length(1); //found only 1
	},
/*
	':target': function () {
